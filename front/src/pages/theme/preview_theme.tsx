    ...
    return (
        <>
            <div className="preview-theme-container">
                ...
                <div className="preview-theme-content mt-3">
                    ...
                    <div className="favorite-btn-list" style={{paddingRight:'30px', paddingLeft:'30px'}}>
                        <div className="favorite-btn">
                            <div className="favorite-btn-icon">
                                <img src="/img/project/favorite.png" />
                            </div>
                            <span className="favorite-btn-name col-8">즐겨찾기</span>
                        </div>
                    </div>
